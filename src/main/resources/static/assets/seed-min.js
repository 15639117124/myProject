 ...
 */(function (e, t) {
    ...
    window.KISSY && !window.KISSY.Node && e.unshift("bui/adapter"), define("bui/common", e, function (e) {
        window.KISSY && !window.KISSY.Node && e("bui/adapter");
        var t = e("bui/util");
        return t.mix(t, {
            UA: e("bui/ua"),
            JSON: e("bui/json"),
    ...
    $.extend(BUI, {
        version: 1, subVersion: 70, isFunction: function (e) {
    ...
    function c(e) {
        return e = $.trim(e), a.test(e) && (e = n.looseParse(e)), e
    }
    ...
    function d(e, t) {
        ...
        s = l(e);
        for (r = s.length - 1; r >= 0; r--)n = s[r], (i = n[o]) && p.call(e, t, i)
    }

    function v(e) {
        var t = e, n = t.get("srcNode"), r, i;
        n && (n = $(n), t.setInternal("el", n), t.setInternal("srcNode", n), r = t.get("userConfig"), i = t.getDecorateConfig(n), h(e, i), t.get("isDecorateChild") && t.decorateInternal && t.decorateInternal(n), d(e, n))
    }
            ...
            return BUI.each(r, function (e) {
                ...
                try {
                    if (t === s) {
                        var n = c(e.nodeValue);
                        BUI.mix(u, n)
                    } else f(t, o) && (t = t.replace(i, ""), u[t] = c(e.nodeValue))
                } catch (r) {
