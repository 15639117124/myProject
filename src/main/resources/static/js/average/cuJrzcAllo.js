BUI.use(['bui/form', 'bui/grid', 'bui/data'],
    function (Form, Grid, Data) {
        ...
        var Store = Data.Store, productInfoColumns = [
            ...
            {title: '金融资产月日均(元)', dataIndex: 'jrzcYrj', width: 100},
            {title: '金融资产季日均(元)', dataIndex: 'jrzcJrj', width: 100},
            {title: '金融资产年日均(元)', dataIndex: 'jrzcNrj', width: 100},
