...
BUI.use(['bui/form', 'bui/grid', 'bui/data'],
    function (Form, Grid, Data) {
        ...
        //精确查询单个产品费用
        //var url_query  = contextPath+"queryProductFee.json";
        var url_query = contextPath + "queryAllProductFee.json";
        /**********************************************渠道费信息Start**************************************************/
        ...
        $("#download").on('click', function () {
            ...
            //精确下载单个产品费用
            //queryForm.set("action","../productFee/downloadProductFee.json");
            queryForm.set("action", "../productFee/downloadProductFeeAll.json");
            queryForm.submit();
        })
    });