BUI.use(['bui/form', 'bui/grid', 'bui/data', 'bui/overlay'],
    function (Form, Grid, Data, Overlay) {
        var contextPath = "../";
        var url_query = contextPath + "product/queryNowRedeemProductAll.json";
        ...
        var redeemColumns = [
            ...
            {title: '产品名称', dataIndex: 'productName', width: 200},
            {title: '可赎回起期', dataIndex: 'redeemBeginDate', width: 80},
            {title: '可赎回止期', dataIndex: 'redeemEndDate', width: 80},
            {title: 'T日起始', dataIndex: 'tBeginDate', width: 80},
            {title: 'T日截止', dataIndex: 'tEndDate', width: 80}
        ];
